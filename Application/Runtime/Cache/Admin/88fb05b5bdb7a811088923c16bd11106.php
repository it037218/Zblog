...
<div id="content">
	...
	<div id="breadcrumb">
		...
		<a class="tip-bottom" href="#" data-original-title="">标签管理</a>
		<a class="current" href="#">添加标签</a>
	</div>
		...
		<div class="span12">
			<div class="widget-box">
				...
				<div class="widget-content nopadding">
					<form action="/Zblog/index.php/Admin/Tags/addTags" method="post" class="form-horizontal" />
